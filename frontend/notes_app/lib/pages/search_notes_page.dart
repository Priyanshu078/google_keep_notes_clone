    ...
    widget.controller.addListener(() {
      ...
      if (state.homeNotesSelected) {
        if (widget.controller.text == "" || widget.controller.text.isEmpty) {
          context.read<SearchBloc>().add(SearchInitialEvent(homeSearch: true));
        } else {
          context.read<SearchBloc>().add(SearchNotesEvent(
        ...
        if (widget.controller.text == "" || widget.controller.text.isEmpty) {
          context.read<SearchBloc>().add(SearchInitialEvent(homeSearch: false));
        } else {
          context.read<SearchBloc>().add(SearchNotesEvent(
                query: widget.controller.text,
                pinnedNotes: const [],
